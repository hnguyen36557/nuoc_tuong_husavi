...
@section('content_admin')
    ...
    <div id="ctl00_divCenter" class="center-nomargins cmszone">
        ...
        <form enctype="multipart/form-data" method="post" action="{!! url('admin/cate/add') !!}" >
                            ...
                            <div class="form-horizontal">
                                ...
                                <div id="ctl00_mainContent_up">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="cate_txtName" type="text" tabindex="1" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" />
                                    ...
                                    <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="cate_sltParent"  class="left" tabindex="2" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
                                    ...
                                    <div class="col-sm-9">
                                       <div class="input-group">
                                            <input type="file" tabindex="3" name="cate_fImages"  size="25">
							     ...
							     <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
	                            	...
	                            	<div class="col-sm-9">
	                            	<div class="input-group">
	                            		<textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="cate_txtContent">{!! old('cate_txtContent') !!}</textarea>
	                            		<div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
	                            	</div>
	                            ...
	                            <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="cate_txtType"  class="left" id="ctl00_mainContent_txtUrl" tabindex="5" class="forminput verywidetextbox">
                                ...
                                <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="cate_sltStatus"  class="left" tabindex="6" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
                                ...
                                <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="cate_txtMenu"  class="left" tabindex="7" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
                                 ...
                                 <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="cate_txtCreateBy" type="text" tabindex="8" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" />
                            ...
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_upSEO">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="cate_txtMetaTitle" type="text" tabindex="9" maxlength="65" id="ctl00_mainContent_txtMetaTitle" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="cate_txtMetaDesc" type="text" maxlength="156" id="ctl00_mainContent_txtMetaDescription" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="cate_txtKeyword" type="text" tabindex="11" maxlength="156" id="ctl00_mainContent_txtMetaKeywords" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
