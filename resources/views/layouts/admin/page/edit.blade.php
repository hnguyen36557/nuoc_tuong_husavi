                            ...
                            <div class="form-horizontal">
                                ...
                                <div id="ctl00_mainContent_up">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtName" type="text" tabindex="1" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" value="{!! old('page_txtName',isset($data) ? $data['name'] : null) !!}" />
                                    ...
                                    <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="page_sltParent"  class="left" tabindex="2" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
                                ...
                                <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
                                    ...
                                    <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="page_txtShortContent">{!! old('page_txtShortContent',isset($data) ? $data['short_content'] : null) !!}</textarea>
                                        <div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
                                    </div>
							     ...
							     <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
	                            	...
	                            	<div class="col-sm-9">
	                            	<div class="input-group">
	                            		<textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="page_txtContent">{!! old('page_txtContent',isset($data) ? $data['long_content'] : null) !!}</textarea>
	                            		<div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
	                            	</div>
                                ...
                                <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="page_sltStatus"  class="left" tabindex="6" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
												@if( $data['enable'] == 0)   
                                                            Disble
                                                        @else
                                                            Enable
                                 ...
                                 <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtCreateBy" type="text" tabindex="8" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" value="@if(Auth::user()) {{ Auth::user()->fullname }} @endif" />
                            ...
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_upSEO">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtMetaTitle" type="text" tabindex="9" maxlength="65" id="ctl00_mainContent_txtMetaTitle" value="{!! old('page_txtMetaTitle',isset($data) ? $data['meta_title'] : null) !!}" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtMetaDesc" type="text" maxlength="156" id="ctl00_mainContent_txtMetaDescription" value="
                                                {!! old('page_txtMetaDesc',isset($data) ? $data['meta_description'] : null) !!}" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtKeyword" type="text" tabindex="11" maxlength="156" id="ctl00_mainContent_txtMetaKeywords" value="{!! old('page_txtKeyword',isset($data) ? $data['meta_keyword'] : null) !!}" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
