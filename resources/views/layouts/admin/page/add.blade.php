...
<div id="page-content-wrapper" class="col-lg-10 col-md-9 col-sm-8">
    <div id="ctl00_divCenter" class="center-nomargins cmszone">
        ...
        <form enctype="multipart/form-data" method="post" action="{!! url('admin/page/add') !!}" >
                            ...
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_up">
                                    ...
                                    <div class="settingrow form-group">
                                        <label for="ctl00_mainContent_txtTitle" class="settinglabel control-label col-sm-3">Tên Trang</label>
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtName" type="text" tabindex="1" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" />
                                ...
                                <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
                                    ...
                                    <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="page_txtShortContent">{!! old('page_txtShortContent') !!}</textarea>
                                        <div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
                                    </div>
							     ...
							     <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
	                            	...
	                            	<div class="col-sm-9">
	                            	<div class="input-group">
	                            		<textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="page_txtContent">{!! old('page_txtContent') !!}</textarea>
	                            		<div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
	                            	</div>
                            ...
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_upSEO">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtMetaTitle" type="text" tabindex="9" maxlength="65" id="ctl00_mainContent_txtMetaTitle" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtMetaDesc" type="text" maxlength="156" id="ctl00_mainContent_txtMetaDescription" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="page_txtKeyword" type="text" tabindex="11" maxlength="156" id="ctl00_mainContent_txtMetaKeywords" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
