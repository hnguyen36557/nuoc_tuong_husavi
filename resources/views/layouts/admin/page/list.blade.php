        ...
        <div class="admin-content col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="pull-right btngroups">
                                                ...
                                                <a id="ctl00_mainContent_adminProduct_lnkInsert" class="btn btn-default btn-insert" href="{!! url('admin/page/add') !!}">Thêm mới</a>
            ...
            <div id="ctl00_mainContent_adminProduct_pnlSearch" class="headInfo form-horizontal" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;ctl00_mainContent_adminProduct_btnSearch&#39;)">             
                <div class="settingrow form-group">
                    <label for="ctl00_mainContent_adminProduct_txtTitle" class="settinglabel control-label col-sm-3">Tên Trang</label>
                    <div class="col-sm-9">
                    ...
                    <!-- 2013.1.417.40 --><table class="rgMasterTable cmstable table table-bordered" id="ctl00_mainContent_adminProduct_grid_ctl00" style="width:100%;table-layout:auto;empty-cells:show;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="rgHeader" style="font-weight:bold;white-space:nowrap;">Tên Trang</th>
                        ...
                        @foreach ($data as $item)
                            <tr class="rgRow" id="ctl00_mainContent_adminProduct_grid_ctl00__0">
                                ...
                                <td>
                                  <a id="ctl00_mainContent_grid_ctl00_ctl04_Hyperlink2" class="cp-link" href="{!! URL::route('admin.page.getEdit', $item['id']) !!}">  {!! $item['name'] !!}</a>
                                </td>
                                <td>
                                    <a id="ctl00_mainContent_adminProduct_grid_ctl00_ctl04_Title" class="cp-link" href="">@if ($item["enable"] == 1)
                                        {!! "Hoạt động" !!}
                                      @else
                                        {!! "Ngừng hoạt động" !!}
                                      @endif</a>
                                ...
                                <td>
                                    <a id="ctl00_mainContent_adminProduct_grid_ctl00_ctl04_EditLink" class="cp-link" href="{!! URL::route('admin.page.getEdit', $item['id']) !!}">Sửa</a>
                                </td>
