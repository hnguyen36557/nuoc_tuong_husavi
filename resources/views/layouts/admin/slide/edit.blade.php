                            ...
                            <div class="form-horizontal">
                                ...
                                <div id="ctl00_mainContent_up">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post_txtName" type="text" tabindex="1" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" value="{!! old('post_txtName',isset($data) ? $data['name'] : null) !!}" />
                                    ...
                                    <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="post_sltParent"  class="left" tabindex="2" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
                                    ...
                                    <div class="col-sm-9">
                                       <div class="input-group">
                                            <?php
                                                ...
                                                ?>
                                                  <img width="100px" height="70px" src="{!! url('public/upload/post/'.$data['featured_image']) !!}" />
                                                  <input type="file" id="exampleInputFile" name="post_fImages" value="{!! old('post_fImages') !!}">
                                ...
                                <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
                                    ...
                                    <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="post_txtShortContent">{!! old('post_txtShortContent',isset($data) ? $data['short_content'] : null) !!}</textarea>
                                        <div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
                                    </div>
							     ...
							     <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
	                            	...
	                            	<div class="col-sm-9">
	                            	<div class="input-group">
	                            		<textarea id="contentText" tabindex="4" rows="4" cols="20"  name="post_txtContent">{!! old('post_txtContent',isset($data) ? $data['long_content'] : null) !!}</textarea>
	                            		<div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
	                            	</div>
	                            ...
	                            <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="post_txtHomeFlat"  class="left" id="ctl00_mainContent_txtUrl" tabindex="5" class="forminput verywidetextbox">
										    @if( $data['home_flat'] == 0)   
                                                Ẩn 
                                            @else
                                                Hiện
                                ...
                                <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
                                            <select name="post_txtHotFlat"  class="left" id="ctl00_mainContent_txtUrl" tabindex="5" class="forminput verywidetextbox">
                                            	@if( $data['hot_flat'] == 0)   
                                                    Ẩn
                                                @else
                                                    Hiện
                                ...
                                <div class="settingrow form-group newsedit-url">
                                        ...
                                        <div class="col-sm-9">
                                        <div class="input-group">
										    <select name="post_sltStatus"  class="left" tabindex="6" id="ctl00_mainContent_txtUrl" class="forminput verywidetextbox">
												@if( $data['enable'] == 0)   
                                                            Disble
                                                        @else
                                                            Enable
                                 ...
                                 <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post_txtCreateBy" type="text" tabindex="8" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" value="@if(Auth::user()) {{ Auth::user()->fullname }} @endif" />
                            ...
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_upSEO">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post_txtMetaTitle" type="text" tabindex="9" maxlength="65" id="ctl00_mainContent_txtMetaTitle" value="{!! old('post_txtMetaTitle',isset($data) ? $data['meta_title'] : null) !!}" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post_txtMetaDesc" type="text" maxlength="156" id="ctl00_mainContent_txtMetaDescription" value="
                                                {!! old('post_txtMetaDesc',isset($data) ? $data['meta_description'] : null) !!}" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post_txtKeyword" type="text" tabindex="11" maxlength="156" id="ctl00_mainContent_txtMetaKeywords" value="{!! old('post_txtKeyword',isset($data) ? $data['meta_keyword'] : null) !!}" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
