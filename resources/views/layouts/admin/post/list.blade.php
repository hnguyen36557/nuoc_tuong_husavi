                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="pull-right btngroups">
                                                ...
                                                <a id="ctl00_mainContent_adminProduct_lnkInsert" class="btn btn-default btn-insert" href="{!! url('admin/post/add') !!}">Thêm mới</a>
                    ...
                    <!-- 2013.1.417.40 --><table class="rgMasterTable cmstable table table-bordered" id="ctl00_mainContent_adminProduct_grid_ctl00" style="width:100%;table-layout:auto;empty-cells:show;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="rgHeader" style="font-weight:bold;white-space:nowrap;">Tiêu Đề</th>
                        ...
                        @foreach ($data as $item)
                            <tr class="rgRow" id="ctl00_mainContent_adminProduct_grid_ctl00__0">
                                ...
                                <td>
                                    <a id="ctl00_mainContent_adminProduct_grid_ctl00_ctl04_EditLink" class="cp-link" href="{!! URL::route('admin.post.getEdit', $item['id']) !!}">Sửa</a>
                                </td>
