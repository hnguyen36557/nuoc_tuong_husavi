...
<div id="page-content-wrapper" class="col-lg-10 col-md-9 col-sm-8">
    <div id="ctl00_divCenter" class="center-nomargins cmszone">
        ...
        <form enctype="multipart/form-data" method="post" action="{!! url('admin/post/add') !!}" >
                        ...
                        <div id="tabContent" role="tabpanel" class="tab-pane fade active in">
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_up">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post_txtName" type="text" tabindex="1" maxlength="255" id="ctl00_mainContent_txtTitle" class="forminput verywidetextbox" />
                                    ...
                                    <div class="col-sm-9">
                                       <div class="input-group">
                                            <input type="file" tabindex="3" name="post_fImages"  size="25">
                                ...
                                <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
                                    ...
                                    <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea id="ctl00_mainContent_edFullContentinnerEditorContentHiddenTextarea" tabindex="4" rows="4" cols="20"  name="post_txtShortContent">{!! old('post_txtShortContent') !!}</textarea>
                                        <div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
                                    </div>
							     ...
							     <div id="ctl00_mainContent_divUploadImage" class="settingrow form-group">
	                            	...
	                            	<div class="col-sm-9">
	                            	<div class="input-group">
	                            		<textarea id="contentText" tabindex="4" rows="4" cols="20"  name="post_txtContent">{!! old('post_txtContent') !!}</textarea>
	                            		<div class="input-group-addon"><a class="mhelp" href="http://www.phannuhoangcung.com/Help.aspx?helpkey=newsedit-metatitle-help"><i class="fa fa-question-circle"></i> </a></div>
	                            	</div>
                            ...
                            <div class="form-horizontal">
                                <div id="ctl00_mainContent_upSEO">
                                    ...
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post__txtMetaTitle" type="text" tabindex="9" maxlength="65" id="ctl00_mainContent_txtMetaTitle" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post__txtMetaDesc" type="text" maxlength="156" id="ctl00_mainContent_txtMetaDescription" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input name="post__txtKeyword" type="text" tabindex="11" maxlength="156" id="ctl00_mainContent_txtMetaKeywords" />
                                                <div class="input-group-addon"><a class="mhelp" href=""><i class="fa fa-question-circle"></i> </a></div>
                                            </div>
                                        </div>
                                    </div>
