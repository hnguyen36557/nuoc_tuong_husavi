        ...
        <section class="breadcb">
	        <div class="col-md-12">
	        	<ol class="breadcrumb">
	        		...
	        		<li class='active'>
	        			<a href=''>Danh sách hình ảnh/ video</a>
	        		</li>
	        	</ol>
	        </div>
        </section>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="pull-right btngroups">
                                                ...
                                                <a id="ctl00_mainContent_adminProduct_lnkInsert" class="btn btn-default btn-insert" href="{!! url('admin/media/add') !!}">Thêm mới</a>
                    ...
                    <!-- 2013.1.417.40 --><table class="rgMasterTable cmstable table table-bordered" id="ctl00_mainContent_adminProduct_grid_ctl00" style="width:100%;table-layout:auto;empty-cells:show;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="rgHeader" style="font-weight:bold;white-space:nowrap;">Tên</th>
                                <th scope="col" class="rgHeader" style="font-weight:bold;">Mô Tả Ngắn</th>
                                <th scope="col" class="rgHeader" style="font-weight:bold;">Người Tạo</th>
                                <th scope="col" class="rgHeader" style="font-weight:bold;">Danh Mục</th>
                        ...
                        @foreach ($data as $item)
                            <tr class="rgRow" id="ctl00_mainContent_adminProduct_grid_ctl00__0">
                                ...
                                <td>
                                    <img width='90px' src="{{ url('public/upload/post/'.$item['featured_image']) }}" alt='serum.png' />
                                </td>
                                <td>
                                  <a id="ctl00_mainContent_grid_ctl00_ctl04_Hyperlink2" class="cp-link" href="{!! URL::route('admin.media.getEdit', $item['id']) !!}">  {!! $item['name'] !!}</a>
                                </td>
                                <td>
                                    <a id="ctl00_mainContent_adminProduct_grid_ctl00_ctl04_Title" class="cp-link" href="">{!! $item['short_content'] !!}</a>
                                </td>
                                <td>
                                    {!! $item['created_by'] !!}
                                </td>
                                <td>
                                    ...
                                    @else
                                        <?php
                                            $parent = DB::table('categorys')->where('id',$item["category_id"])->first();
                                            //if ($parent!=null) {
                                                echo $parent->name;
                                            //}
                                ...
                                <td>
                                    <a id="ctl00_mainContent_adminProduct_grid_ctl00_ctl04_EditLink" class="cp-link" href="{!! URL::route('admin.media.getEdit', $item['id']) !!}">Sửa</a>
                                </td>
